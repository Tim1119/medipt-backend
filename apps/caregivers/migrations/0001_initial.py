    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=255, verbose_name='Caregiver First Name')),
                ('last_name', models.CharField(max_length=255, verbose_name='Caregiver Last Name')),
                ...
                ('profile_picture', imagekit.models.fields.ProcessedImageField(default='default.png', upload_to='caregiver_profile_pictures', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg'])])),
